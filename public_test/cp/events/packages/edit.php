<?
	...
	if (!$_SESSION['forms']['edit-package']['packageId']) {
		...
		if ($_SESSION['forms']['edit-package']['registrationStartDate']) {
			$_SESSION['forms']['edit-package']['registrationStartTime'] = date('g:i A', $_SESSION['forms']['edit-package']['registrationStartTime']);
		...
		if ($_SESSION['forms']['edit-package']['registrationDeadlineDate']) {
			$_SESSION['forms']['edit-package']['registrationDeadlineTime'] = date('g:i A', $_SESSION['forms']['edit-package']['registrationDeadlineTime']);
